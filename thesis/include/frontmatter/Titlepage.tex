...
\includegraphics[clip, trim={1cm 20cm 1cm 10cm},width=0.9\linewidth, angle=180]{figure/auxiliary/Cover-image.jpeg}
\end{figure}
...
Examiner: Krasimir Angelov, Department of Computer Science and Engineering \setlength{\parskip}{1cm}
...
% Description of the picture on the cover page (if applicable)
