...
In the beginning was the word and it was good. However, it is difficult to make computers understand natural languages. There are many different approaches that has been used to make this process easier. In this thesis we will focus on two such ways\todo{annat ord?}, both of which are meant to analyse the grammatical structure and syntax of a sentence.
